module EDPftvarcon
  ...
  type, public ::  EDPftvarcon_type
     ...
     real(r8), allocatable :: eca_vcmax_np1(:)
     real(r8), allocatable :: eca_vcmax_np2(:)
     real(r8), allocatable :: eca_vcmax_np3(:)
     real(r8), allocatable :: eca_vcmax_np4(:)
...
contains
  ...
  subroutine Receive_PFT(this, fates_params)
    ...
    name = 'fates_eca_vcmax_np1'
    call fates_params%RetreiveParameterAllocate(name=name, &
         data=this%eca_vcmax_np1)

    name = 'fates_eca_vcmax_np2'
    call fates_params%RetreiveParameterAllocate(name=name, &
         data=this%eca_vcmax_np2)

    name = 'fates_eca_vcmax_np3'
    call fates_params%RetreiveParameterAllocate(name=name, &
         data=this%eca_vcmax_np3)
